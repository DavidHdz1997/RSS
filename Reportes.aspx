<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reportes.aspx.cs" Inherits="BackRSS.Reportes" %>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped table-condensed mb-none" EmptyDataText = "No hay reportes subidos aun">
                                        <Columns>
